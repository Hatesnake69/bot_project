...
fin6 = KeyboardButton('У меня неверная информация в дата-студию к кому обратиться?')
...
tech2 = KeyboardButton('Хочу проходить курсы, к кому обратиться по моему обучению?')
