...
from bot import scheduled_all, bot
...
def set_scheduler(user_id: int, event: str, event_date: str, event_time: str, comment: str):
    """
    ...
    scheduler.add_job(send_reminder_to_user, 'date', run_date=reminder_time, args=[user_id, text_for_scheduler])


async def send_reminder_to_user(user_id: int, reminder_text: str):
    """
